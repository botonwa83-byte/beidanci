...
const P = (text: string, meaning: string): GuessSegment => ({
  type: 'prefix',
  text,
  meaning,
});
const R = (text: string, meaning: string): GuessSegment => ({
  type: 'root',
  text,
  meaning,
});
const S = (text: string, meaning: string): GuessSegment => ({
  type: 'suffix',
  text,
  meaning,
});
...
export const guessWords: GuessWord[] = [
  {
    ...
    phonetic: '/ˌsɜːkəmˌnævɪˈɡeɪʃn/',
    pos: 'n.',
    meaning: '环球航行',
    hint: '环绕 + 航行 + 名词 → 绕着地球航行一圈',
    segments: [
      P('circum', '环绕'),
      R('navig', '航行（navis 船）'),
      S('ation', '名词'),
  ...
  {
    word: 'insecticide',
    phonetic: '/ɪnˈsektɪsaɪd/',
    pos: 'n.',
    meaning: '杀虫剂',
    hint: '昆虫 +（连接 i）+ 杀 → 杀昆虫的药',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '心脏病专家',
    hint: '心脏 + 学 + ……的人 → 研究心脏的医生',
    segments: [R('cardio', '心脏'), R('log', '学'), S('ist', '……的人')],
  },
  {
    word: 'orthodontist',
    phonetic: '/ˌɔːθəˈdɒntɪst/',
    pos: 'n.',
    meaning: '牙齿矫正医生',
    hint: '正/直 + 牙齿 + ……的人 → 把牙齿弄整齐的医生',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '首字母缩略词',
    hint: '顶端/首 + 名字 → 取每个词开头拼成的名字',
    segments: [R('acr', '顶端、首'), R('onym', '名字')],
  },
  {
    word: 'bibliophile',
    phonetic: '/ˈbɪbliəfaɪl/',
    pos: 'n.',
    meaning: '爱书者；藏书家',
    hint: '书 + 爱好者 → 极爱书的人',
  ...
  {
    word: 'kleptomania',
    phonetic: '/ˌkleptəˈmeɪniə/',
    pos: 'n.',
    meaning: '盗窃癖',
    hint: '偷窃 + 狂癖 → 控制不住要偷的癖好',
  ...
  {
    word: 'oceanography',
    phonetic: '/ˌəʊʃəˈnɒɡrəfi/',
    pos: 'n.',
    meaning: '海洋学',
    hint: '海洋 +（连接 o）+ 书写 → 描述海洋的学问',
    segments: [R('ocean', '海洋'), L('o'), R('graph', '书写'), S('y', '名词')],
  },
  {
    word: 'cartography',
    phonetic: '/kɑːˈtɒɡrəfi/',
    pos: 'n.',
    meaning: '制图学',
    hint: '地图 + 书写 → 绘制地图的学问',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '段落',
    hint: '旁边 + 书写 → 旁边另起一行写的一段',
    segments: [P('para', '旁边'), R('graph', '书写')],
  },
  {
    word: 'seismograph',
    phonetic: '/ˈsaɪzməɡrɑːf/',
    pos: 'n.',
    meaning: '地震仪',
    hint: '地震 + 记录 → 记录地震的仪器',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '生态学',
    hint: '环境/家 + 学科 → 研究生物与环境的学问',
    segments: [R('eco', '环境、家'), R('logy', '学科')],
  },
  {
    word: 'neurology',
    phonetic: '/njʊˈrɒlədʒi/',
    pos: 'n.',
    meaning: '神经病学',
    hint: '神经 + 学科 → 研究神经的医学',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '方法论',
    hint: '方法 +（连接 o）+ 学科 → 关于方法的系统理论',
    segments: [R('method', '方法'), L('o'), R('logy', '学科')],
  },
  {
    word: 'genealogy',
    phonetic: '/ˌdʒiːniˈælədʒi/',
    pos: 'n.',
    meaning: '家谱；宗谱学',
    hint: '家系 + 学科 → 研究家族血脉的学问',
  ...
  {
    word: 'bactericide',
    phonetic: '/bækˈtɪərɪsaɪd/',
    pos: 'n.',
    meaning: '杀菌剂',
    hint: '细菌 +（连接 i）+ 杀 → 杀细菌的药',
  ...
  {
    word: 'parenthesis',
    phonetic: '/pəˈrenθəsɪs/',
    pos: 'n.',
    meaning: '圆括号；插入语',
    hint: '旁边 +（插入 en）+ 放置 → 放在旁边的插入内容',
  ...
  // ==================== -ation / -ion 过程·结果 ====================
  {
    ...
    pos: 'n.',
    meaning: '星座；星群',
    hint: '共同 + 星 + 名词 → 聚在一起的一群星',
    segments: [P('con', '共同'), R('stell', '星'), S('ation', '名词')],
  },
  {
    word: 'illumination',
    phonetic: '/ɪˌluːmɪˈneɪʃn/',
    pos: 'n.',
    meaning: '照明；启发',
    hint: '使 + 光 + 名词 → 使其发光',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '保护；保存',
    hint: '共同 + 保持 + 名词 → 一起守住不让流失',
    segments: [P('con', '共同'), R('serv', '保持'), S('ation', '名词')],
  },
  {
    word: 'malnutrition',
    phonetic: '/ˌmælnjuˈtrɪʃn/',
    pos: 'n.',
    meaning: '营养不良',
    hint: '不良 + 营养 + 名词 → 营养出问题',
  ...
  {
    word: 'malevolence',
    phonetic: '/məˈlevələns/',
    pos: 'n.',
    meaning: '恶意',
    hint: '坏 +（连接 e）+ 意愿 + 名词 → 怀着坏心意',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '平衡',
    hint: '相等 + 秤/平衡 + 名词 → 两边一样重',
    segments: [P('equi', '相等'), R('libr', '秤、平衡'), S('ium', '名词')],
  },
  {
    word: 'omnipotence',
    phonetic: '/ɒmˈnɪpətəns/',
    pos: 'n.',
    meaning: '全能；无所不能',
    hint: '全部 + 力量 + 名词 → 拥有一切力量',
  ...
  },
  {
    ...
    pos: 'n.',
    meaning: '对手；反派',
    hint: '相反 + 争斗 + ……的人 → 与主角作对的人',
    segments: [P('ant', '相反'), R('agon', '争斗'), S('ist', '……的人')],
  },
  {
    word: 'monotheism',
    phonetic: '/ˈmɒnəʊθiːɪzəm/',
    pos: 'n.',
    meaning: '一神论',
    hint: '单一 + 神 + 主义 → 只信一个神',
...
export const getRelatedWords = (
  ...
  for (const seg of target.segments) {
    if (seg.type !== 'root' && seg.type !== 'prefix') {
      continue;
    }
    if (!seg.meaning) {
      continue;
