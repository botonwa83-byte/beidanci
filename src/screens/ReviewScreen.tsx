        ...
        <ScrollView contentContainerStyle={styles.resultContent}>
          ...
          <View style={styles.resultStats}>
            <View style={styles.resultStat}>
              <Text
                style={[styles.resultStatNum, {color: theme.colors.success}]}>
                {correct}
              </Text>
              <Text style={styles.resultStatLabel}>正确</Text>
            </View>
            <View style={styles.resultStat}>
              <Text style={[styles.resultStatNum, {color: theme.colors.error}]}>
                {wrong}
              </Text>
            ...
            <View style={styles.resultStat}>
              <Text
                style={[styles.resultStatNum, {color: theme.colors.primary}]}>
                {total}
              </Text>
