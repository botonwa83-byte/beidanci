...
## 进行中
- [词源宇宙计划](etymology-universe-plan.md) — **当前主线**：三层词源体系("没有一个单词是凭空来的")，哑词身世故事/今日冷知识/猜来历/词源版图
- [待办任务清单](pending-tasks.md) — 全部未完成任务（16项），⚠️含另一台电脑内购代码未提交的高风险项
- [反平庸改造计划](redesign-plan-2026-06.md) — 五波已完成并推送：破译力/先猜后揭/拼词工坊/扫荡/派生带学/多义项；星系图与撤语法tab待做
- [Freemium 商业化方案](freemium-model.md) — 免费下载+¥12买断，3处门禁(猜词/学习/语法)，代码在另一台电脑未提交
